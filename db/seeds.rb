...
oiseau2 = Faune.create(categorie:"Oiseaux", nom: "Rousserolle effarvatte", description: "La Rousserolle effarvatte, oiseau chanteur discret des zones de roseaux et des marais de Merlimont, arbore un plumage brunâtre et terne. Son chant mélodieux, bien que discret, ajoute une symphonie naturelle aux douces brises des milieux humides. Également migratrice, elle traverse les cieux, ajoutant une touche de grâce à l'écosystème local.")
...
oiseau5 = Faune.create(categorie:"Oiseaux", nom: "Goéland argenté", description: "Majestueux et imposant, le Goéland argenté survole les plages de Merlimont, scrutant les eaux pour sa proie. Son plumage argenté et ses cris distinctifs en font un résident notable du littoral. Cet oiseau opportuniste joue un rôle crucial dans l'équilibre de l'écosystème côtier.")
...
oiseau7 = Faune.create(categorie:"Oiseaux", nom: "Fulmar boréal", description: "Voguant majestueusement au-dessus des vagues, le Fulmar boréal, au plumage blanc et gris, niche sur les falaises côtières de Merlimont. Son vol gracieux et son cri distinctif ajoutent une dimension marine à l'écosystème côtier.")
...
mamiterre2 = Faune.create(categorie:"Mammifères terrestres", nom: "Renard roux", description: "Carnivore rusé au pelage roux, le Renard roux est un habitant polyvalent des écosystèmes de Merlimont, s'adaptant aux forêts, aux prairies et aux zones urbaines. Chasseur nocturne, il incarne la nature sauvage de la région.")
...
poisson1 = Faune.create(categorie:"Poissons", nom: "Émissole tachetée", description: "Dans les eaux côtières de Merlimont, l'Émissole tachetée se faufile, un poisson agile au corps élancé marqué de taches sombres. Avec son camouflage discret parmi les fonds sableux, elle chasse discrètement ses proies. Mesurant généralement entre 15 et 30 centimètres, elle se fond dans ce décor côtier, vigilante et prédatrice. Toutefois, méfiez-vous de ses nageoires dorsales venimeuses, un rappel de sa défense naturelle pour ceux qui viendraient troubler sa quiétude marine.")
...
poisson2 = Faune.create(categorie:"Poissons", nom: "Truite fario", description: "La Truite fario, habitante des cours d'eau frais et clairs de Merlimont, se distingue par ses taches noires et rouges sur un fond brun. Sa chair délicate en fait une cible prisée des pêcheurs locaux.")
...
poisson3 = Faune.create(categorie:"Poissons", nom: "Anguille d'Europe", description: "L'Anguille d'Europe, serpentiforme et glissante, navigue dans les eaux douces de Merlimont. Connue pour ses migrations extraordinaires, elle complète son cycle de vie entre les rivières et la mer.")
...
crustace4 = Faune.create(categorie:"Crustacés", nom: "Cloporte", description: "Le Cloporte, également appelé « bateau ivre », est un crustacé terrestre que l'on trouve dans les zones humides et les sous-bois de Merlimont. Bien que terrestre, il est étroitement lié à l'environnement aquatique.")
...
insecte3 = Faune.create(categorie:"Insectes & arthropodes", nom: "Libellule déprimée", description: "La Libellule déprimée, avec ses ailes translucides et son abdomen allongé, patrouille gracieusement au-dessus des étangs et des rivières de Merlimont. Ses vols acrobatiques ajoutent une touche de magie à l'environnement aquatique.")
...
reptile1 = Faune.create(categorie:"Reptiles", nom: "Couleuvre à collier", description: "La Couleuvre à collier, serpent non-venimeux, glisse silencieusement le long des rivières et des étangs de Merlimont. Reconnaissable par son collier jaune vif, elle se nourrit de poissons, d'amphibiens et de petits rongeurs.")
...
reptile2 = Faune.create(categorie:"Reptiles", nom: "Vipère péliade", description: " La Vipère péliade, serpent venimeux mais non mortel, se trouve dans les zones boisées de Merlimont. Son motif en zigzag sur le dos et sa couleur variable la rendent bien adaptée à la camouflage dans son environnement naturel.")
...
reptile3 = Faune.create(categorie:"Reptiles", nom: "Orvet fragile", description: "L'Orvet fragile, souvent confondu avec un serpent, est en réalité une espèce de lézard sans pattes. Il se faufile à travers l'herbe des prairies et des jardins de Merlimont, se nourrissant principalement d'insectes.")
...
amphibien1 = Faune.create(categorie:"Amphibiens", nom: "Grenouille agile", description: "La Grenouille agile, de couleur vert vif, est souvent repérée autour des mares et des rivières de Merlimont. Ses sauts puissants et son chant mélodieux ajoutent une dimension vivante aux milieux humides.")
...
amphibien2 = Faune.create(categorie:"Amphibiens", nom: "Salamandre tachetée", description: "La Salamandre tachetée, aux couleurs vives et aux taches distinctives, se terre dans les endroits humides et boisés de Merlimont. Ses motifs avertisseurs signalent sa toxicité, faisant d'elle une créature fascinante.")
...
amphibien3 = Faune.create(categorie:"Amphibiens", nom: "Travertin alpestre", description: "Le Triton alpestre, amphibien de petite taille, trouve refuge dans les zones humides et boisées de Merlimont. Son apparence élégante et ses motifs délicats en font un sujet d'étude passionnant pour les amateurs de nature.")
...
amphibien4 = Faune.create(categorie:"Amphibiens", nom: "Crapaud calamite", description: "Le Crapaud calamite, au dos rugueux et à la couleur variable, est souvent présent dans les prairies et les zones humides de Merlimont. Il se nourrit d'insectes et émet un chant caractéristique pendant la période de reproduction.")
...
petitmam2 = Faune.create(categorie:"Petits mammifères", nom: "Campagnol des champs", description: "Le Campagnol des champs, avec son pelage brun et sa queue courte, prospère dans les champs et les prairies de Merlimont. Cet herbivore joue un rôle essentiel dans la chaîne alimentaire locale.")
